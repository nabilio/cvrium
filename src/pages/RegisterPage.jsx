...
const RegisterPage = ({ onLogin }) => {
  ...
  const handleRegister = (e) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Bienvenue sur CV Generator Pro",
      });
      navigate('/dashboard');
      setLoading(false);
    }, 1000);
  ...
  return (
    <>
      <Helmet>
        <title>Inscription - CV Generator Pro</title>
        <meta name="description" content="Créez votre compte CV Generator Pro gratuitement" />
      </Helmet>
      <div className="min-h-screen flex items-center justify-center px-6 py-12">
        ...
        >
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold mb-2">Créez votre compte</h1>
            <p className="text-gray-400">Commencez à créer des CV professionnels</p>
          </div>
