...
const CVEditor = ({ user, onLogout }) => {
  ...
  const handleImproveSummary = async () => {
    ...
    try {
      const prompt =
        `Réécris et améliore ce résumé professionnel pour le rendre percutant, clair et concis. ` +
      ...
      toast({
        ...
        description:
          error?.message === "AI_JSON_PARSE_ERROR"
            ? "L'IA a répondu avec un format inattendu. Réessayez avec un texte plus concis."
  ...
  const handleParseWithAI = async () => {
    ...
    try {
      ...
      switch (aiCategory) {
        ...
        default:
          jsonStructure =
            '{ "personalInfo": { "fullName": "", "email": "", "phone": "" }, "summary": "", "experience": [{ "company": "", "position": "", "period": "", "location": "", "description": "" }], "education": [{ "school": "", "degree": "", "period": "", "location": "" }], "skills": [{ "category": "", "technologies": "" }], "languages": [{ "language": "", "level": "" }], "certifications": [{ "name": "", "issuer": "", "date": "" }] }';
      ...
      setCvData((prev) => {
        ...
        if (
          ...
          (aiCategory === "all" || aiCategory === "summary")
        ) {
      ...
      toast({
        ...
        description:
          error?.message === "AI_JSON_PARSE_ERROR"
            ? "L'IA a répondu avec un format inattendu. Réessayez en réduisant le texte ou en précisant la demande."
            : "Vérifiez votre clé API ou réessayez. L'IA a peut-être eu du mal à comprendre le texte.",
        variant: "destructive",
      });
    } finally {
      setIsParsing(false);
  ...
  const handleFileUpload = (event) => {
    ...
    reader.onload = (e) => {
      ...
      toast({
        ...
        description:
          "Le contenu du fichier a été ajouté au champ de l'assistant IA.",
      });
    };
    reader.onerror = () => {
      toast({
  ...
  const handleGenerateModernCV = async () => {
    if (!aiText.trim()) {
      toast({
        ...
        description:
          "Importez ou collez votre ancien CV avant de lancer la génération IA.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      const sanitizedText = sanitizeForPrompt(aiText);
      const prompt =
        `Tu es un expert RH. Transforme ce CV en version moderne, impactante et concise. ` +
      ...
      toast({
        title: "CV modernisé !",
        description:
          "Votre ancien CV a été restructuré dans un format moderne.",
      });
    } catch (error) {
      ...
      toast({
        ...
        description:
          error?.message === "AI_JSON_PARSE_ERROR"
            ? "Impossible d'analyser le JSON retourné par l'IA. Réessayez avec un texte plus clair."
            : "Une erreur est survenue lors de l'appel à l'IA. Vérifiez la clé API et réessayez.",
        variant: "destructive",
      });
    } finally {
  ...
  const handleSave = (status = "published") => {
    ...
    setTimeout(() => {
      ...
      toast({
        title:
          status === "draft" ? "Brouillon enregistré ✨" : "CV sauvegardé ! 🎉",
        description:
          status === "draft"
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Créez ou modifiez votre CV professionnel"
        />
      </Helmet>
          ...
          <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="text-gray-400 mt-2">
                Remplissez les informations de votre CV
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div className="glass-effect p-6 rounded-2xl space-y-4">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                <div>
                  <h2 className="text-2xl font-bold flex items-center gap-2">
                    <Wand2 className="w-6 h-6 text-cyan-400" /> Magie IA -
                    Pré-remplissage
                  </h2>
                  <p className="text-gray-400 text-sm">
                    Collez un CV existant, importez un fichier ou choisissez la
                    section à remplir et laissez l'IA faire le travail.
                  </p>
                </div>
                <Button
              ...
              <div className="flex flex-col gap-4 lg:flex-row">
                <div className="flex-1">
                  <Label htmlFor="ai-text" className="text-sm text-gray-300">
                    Ancien CV ou texte brut
                  </Label>
                  <Textarea
                    id="ai-text"
                    value={aiText}
            ...
            <div className="glass-effect p-6 rounded-2xl">
              <h2 className="text-2xl font-bold mb-4 flex items-center gap-2">
                <LayoutTemplate className="w-6 h-6 text-purple-300" /> Templates
                modernes
              </h2>
              <p className="text-sm text-gray-400 mb-4">
                Choisissez un style de CV. Vous pourrez toujours changer de
                modèle dans l'aperçu.
              </p>
              <div className="grid gap-4 md:grid-cols-3">
                {CV_TEMPLATE_LIST.map((template) => (
                  ...
                  >
                    <div
                      className={`h-20 rounded-lg bg-gradient-to-r ${template.accent} opacity-90 group-hover:opacity-100 transition-opacity`}
                    />
                    ...
                    {cvData.templateId === template.id && (
                      <span className="absolute top-3 right-3 text-xs text-purple-200">
                        Sélectionné
                      </span>
                    )}
                  </button>
            ...
            <div className="glass-effect p-6 rounded-2xl">
              <h2 className="text-2xl font-bold mb-4 flex items-center gap-2">
                <Sparkles className="w-6 h-6 text-purple-400" /> Paramètres du
                CV
              </h2>
              ...
              <div className="mt-4 flex items-center gap-2">
                ...
                >
                  <Shield className="w-4 h-4 text-purple-400" /> Version anonyme
            ...
            <div className="glass-effect p-6 rounded-2xl">
              ...
              {(cvData.experience || []).map((exp, index) => (
                <div
                  key={index}
                  className="mb-4 p-4 bg-white/5 rounded-lg relative"
                >
            ...
            <div className="glass-effect p-6 rounded-2xl">
              <div className="flex items-center justify-between mb-4">
                ...
                <Button
                  onClick={() =>
                    addDynamicItem("skills", { category: "", technologies: "" })
                  }
                  size="sm"
                  className="bg-purple-600 hover:bg-purple-700"
                >
