    ...
    const AIOptimizer = ({ user, onLogout }) => {
      ...
      const handleOptimize = async () => {
        if (!jobOffer.trim() || !cvData) {
          toast({
            ...
            description: "Veuillez coller l'offre d'emploi et vous assurer que le CV est chargé.",
            variant: "destructive",
          });
          return;
        }
        ...
        setOptimizing(true);
        setSuggestions(null);
        toast({ title: "Optimisation IA en cours...", description: "L'IA analyse votre CV et l'offre d'emploi." });
        ...
        try {
            ...
            toast({
                ...
                description: "Vérifiez votre clé API ou réessayez. Si le problème persiste, le service OpenAI est peut-être indisponible.",
                variant: "destructive",
            });
        } finally {
            setOptimizing(false);
      ...
      const handleApplySuggestions = () => {
        toast({
          ...
          description: "L'application automatique des suggestions arrive bientôt ! Pour l'instant, vous pouvez les appliquer manuellement. 🚀",
        });
      };
      ...
      return (
        <>
          <Helmet>
            ...
            <meta name="description" content="Optimisez votre CV avec l'intelligence artificielle" />
          </Helmet>
          <DashboardLayout user={user} onLogout={onLogout}>
            <div className="max-w-5xl mx-auto">
              <div className="mb-8 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Adaptez votre CV à une offre d'emploi spécifique</p>
                </div>
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-6">
                ...
                <div className="glass-effect p-6 rounded-2xl">
                  <h2 className="text-2xl font-bold mb-4 flex items-center gap-2">
                    <Brain className="w-6 h-6 text-purple-400" /> Suggestions d'optimisation
                  </h2>
                  {!suggestions && !optimizing ? (
                    <div className="text-center py-20 flex flex-col items-center justify-center h-full">
                      <Brain className="w-16 h-16 text-gray-600 mx-auto mb-4" />
                      <p className="text-gray-400">
                        Collez une offre d'emploi et cliquez sur "Analyser" pour recevoir des suggestions personnalisées.
                      </p>
                    </div>
                  ) : null}
                   {optimizing ? (
                  ...
                  {suggestions ? (
                    <div className="space-y-6">
                      <div className="bg-white/5 p-4 rounded-lg">
                        <h3 className="font-bold text-purple-400 mb-2">📝 Résumé</h3>
                        <p className="text-gray-300 text-sm">{suggestions.summary}</p>
                      </div>

                      <div className="bg-white/5 p-4 rounded-lg">
                        <h3 className="font-bold text-purple-400 mb-2">💡 Compétences</h3>
                      ...
                      <div className="bg-white/5 p-4 rounded-lg">
                        <h3 className="font-bold text-purple-400 mb-2">🎯 Expérience</h3>
                        <ul className="space-y-2">
                      ...
                      <div className="bg-white/5 p-4 rounded-lg">
                        <h3 className="font-bold text-purple-400 mb-2">🔑 Mots-clés importants</h3>
                      ...
                      >
                        <Sparkles className="w-4 h-4 mr-2" /> Appliquer les suggestions
                      </Button>
                    </div>
                  ) : null}
                </div>
